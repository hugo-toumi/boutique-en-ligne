...
if(!empty($_POST['prenom'])&& !empty($_POST['nom'])&& !empty($_POST['password'])&& !empty($_POST['password_confirm'])){
  ...
  $req = $db->prepare("INSERT INTO membre(prenom, nom, pseudo, mdp, ) VALUES(?,?,?,?)");
...
<body>
    ...
    <p id="info">Bienvenue sur mon site pour en voir plus, inscrivez vous. Sinon <a href="deconnexion.php">Déconnetez-vous</a><p>
